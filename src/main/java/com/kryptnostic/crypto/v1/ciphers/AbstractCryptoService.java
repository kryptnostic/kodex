...
public abstract class AbstractCryptoService {
    ...
    public BlockCiphertext encrypt( byte[] bytes, byte[] salt ) throws InvalidKeySpecException, NoSuchAlgorithmException,
    ...
    public byte[] decryptBytes( BlockCiphertext ciphertext ) throws InvalidKeyException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeySpecException {
