...
public class SimplePolynomialFunctionValidator implements Serializable {
    ...
    private static final JacksonKodexMarshaller<SimplePolynomialFunctionValidator> marshaller = new JacksonKodexMarshaller<SimplePolynomialFunctionValidator>( SimplePolynomialFunctionValidator.class );
