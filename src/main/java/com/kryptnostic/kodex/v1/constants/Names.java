...
public final class Names {
    ...
    public static final String EXPECTED_NUMBER_OF_USER_FIELD   = "expectedNumberOfUsers";
    public static final String USE_CASE_FIELD                  = "usecase";
    ...
    public static final String INHERITING_OWNERSHIP_FIELD      = "inheritOwnership";
