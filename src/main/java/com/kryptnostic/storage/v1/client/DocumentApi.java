...
public interface DocumentApi {
     ...
     */
    @PUT(DOCUMENT)
    BasicResponse<String> createPendingDocument(@Body DocumentCreationRequest request) throws BadRequestException;
     ...
     *             if the document is currently pending
     * @throws ResourceNotFoundException
     *             the document doesnt exist
     */
    @PUT(DOCUMENT + "/{" + ID + "}")
    BasicResponse<String> createPendingDocument(@Path(ID) String documentId, @Body DocumentCreationRequest request)
     ...
     * @throws ResourceNotFoundException
     *             if specified documentId was not found
     * @throws ResourceNotLockedException
     *             if the specified document has not been locked for updating
     * @throws BadRequestException
